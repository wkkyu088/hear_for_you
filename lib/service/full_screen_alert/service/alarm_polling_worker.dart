...
class AlarmPollingWorker {
  ...
  Future<void> createPollingWorker(AlarmState alarmState) async {
    ...
    if (callbackAlarmId != null) {
      // debugPrint("callbackAlarmId 1: ${alarmState.callbackAlarmId}");
      // debugPrint("isFired 1: ${alarmState.isFired}");
      if (!alarmState.isFired) {
        alarmState.fire(callbackAlarmId);
      }
      // debugPrint("alarm flag manager clear");
      // debugPrint("callbackAlarmId 2: ${alarmState.callbackAlarmId}");
      // debugPrint("isFired 2: ${alarmState.isFired}");
